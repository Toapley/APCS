...
{	
    ...
    @Test public void testError27() {assertEquals("<ERROR> Invalid operator encountered: +++", Calculator.produceAnswer("3 +++ y"));}
    @Test public void testError28() {assertEquals("<ERROR> Invalid operator encountered: +=+=", Calculator.produceAnswer("3 +=+= y"));}
    ...
    @Test public void testErrorFinal9() {assertEquals("<ERROR> Invalid operator encountered: <=", Calculator.produceAnswer("3 - 4 <="));}	
}
